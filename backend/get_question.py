...
#     lambda x: ", ".join([f"{opt['identifier']}: {opt['content']}" for opt in eval(x)])
# )
...
#     data['topic'] + " , " +
#     data['question'] + " , " +
#     data['options'] + " , " +  # Convert options from string to list and join
#     data['correct_option'] + " , " +
#     data['explanation'] + " , Examination and Year :" + data['paper_id']
# )
